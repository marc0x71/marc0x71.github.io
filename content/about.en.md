+++
title = "Hi, I'm Marco and I (Still) Want to Learn"
date = 2026-01-17
+++
...
## The Year 2000 and My "Initiation" into Unix

Let me tell you a story. It was 2000, I came from the DOS/Windows world like practically everyone else, and I was assigned to a project that used Unix servers. My toolkit? The basic commands to navigate folders (`cd`, `ls`...) that I used when connecting via FTP (the "s" in front of FTP wasn't even a thing back then).
...
On my [YouTube channel](https://www.youtube.com/playlist?list=PL75yUkG-fXnv0fkK0zNgsU8malexOdCsp) you'll find a complete Rust course for those starting from scratch, but also tutorials on tools I use daily: Vim/NeoVim (yes, I'm one of those who can't stop using it, and now you understand why) and Git.

## What Will You Find Here?

- Tutorials and explanations on **Rust**, from basic level to more advanced concepts
- Practical guides on **Vim/NeoVim** and **Git** (tools I learned "in the field")
...
- 💻 [GitHub](https://github.com/marc0x71) - My projects and code
